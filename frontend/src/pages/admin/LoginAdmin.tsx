    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response?.token && response?.user) {
                if (response.user.role === 'admin' || response.user.role === 'management') { // Pastikan role Administrator (case sensitive)
                    ...
                    showNotification("Role Anda tidak diizinkan mengakses halaman ini.", "error");
                }
            } else {
