...
export default function Navbar({ toggleSidebar, isSidebar }: NavbarProps) {
    ...
    return (
        ...
        >
            <nav
                className={`flex items-center justify-between lg:py-6 p-4 mx-0 lg:mx-4 transition-all duration-300 ${isScrolled
                    ? `bg-white shadow-md rounded-md ${isSidebar ? "mx-0 lg:mx-6" : "mx-0 lg:mx-20"}`
            ...
            >
                <div className="flex items-center space-x-6">
                    <button
                        ...
                        className={`p-2 transition rounded-full ${isSidebar
